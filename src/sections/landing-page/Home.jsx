                ...
                <section className="">
                    <div className="mb-20 xxl:grid grid-cols-2 justify-between xxl:text-left">
                        ...
                        <p>
                            ...
                            embark on your event planning venture. Start your
                            event planning journey with ease and unlock the
                ...
                <section className="bg-pry-purple px-6 md:px-16 -mx-6 md:-mx-16 ">
                    <div className="xxl:grid grid-cols-2 xxl:text-left mb-16">
                        ...
                        <p className="text-pry-text-color-2">
                            ...
                            opportunities, entertainment, or a chance to support
                            a worthy cause, our featured events offer something
                            for everyone.
                        </p>
                    </div>
                    <div className="">
                ...
                <section className="">
                    <div className="xxl:grid grid-cols-2 xxl:text-left mb-12">
                        ...
                        <p>
                            ...
                            experience for our clients. Don't just take our word
                            for it—see what our clients have to say about their
                ...
                <section className="max-w-3xl mx-auto faq">
                    <div className="mb-16">
                        ...
                        <p>
                            ...
                            queries about Deleventus. Find answers to your
                            questions below, and if you don't see what you're
                            looking for, feel free to reach out to our support
                ...
                <section className="text-center bg-pry-purple py-16 px-6 md:px-16 -mx-6 md:-mx-16">
                    <div className="font-medium py-12 px-6 max-w-3xl mx-auto rounded-lg contact">
                        ...
                        <p className="text-sm text-contact-text-color font-light md:text-base md:w-3/4 md:mx-auto">
                            ...
                            memories. Capture and share photos/videos, manage
                            ticket sales, engage with attendees, and preserve
                            valuable remarks. Say goodbye to scattered albums
